          ...
          <div className="col-12 col-lg-10">
            ...
            <div className="text-center mb-5">
              ...
              <div className="d-flex justify-content-center mb-4">
                ...
                >
                  <i
                    className="bi bi-film text-dark"
              ...
              <div className="mb-4">
                <h1 className="display-4 fw-bold text-white mb-3">
                  Welcome to{" "}
                  <span className="gold-gradient-text">MovieSquad</span>
                </h1>
                <p
                  className="lead text-light mx-auto"
                  style={{ maxWidth: "600px" }}
                >
                  Connect with fellow movie and TV enthusiasts. Share reviews,
                  discover new content, and join passionate discussions about
              ...
              {isAuthenticated && (
                <div className="d-flex flex-column flex-sm-row gap-3 justify-content-center mb-5">
                  <Link
                    to="/feed"
                    className="btn btn-gold btn-lg px-4 py-3 fw-semibold rounded-pill"
                  >
                ...
                <div className="glass-card h-100 hover-lift rounded">
                  <div className="card-body p-5">
                    ...
                    <p className="text-light mb-4">
                      Write detailed reviews, rate movies and TV shows, and help
              ...
              <div className="col-md-6">
                <div className="glass-card h-100 hover-lift rounded">
                  <div className="card-body p-5">
                    ...
                    <p className="text-light mb-4">
                      Connect with fans who share your taste in movies and TV
                      shows. Join genre-specific groups.
                    </p>
