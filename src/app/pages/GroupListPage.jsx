...
export default function GroupListPage({
            ...
            <div className="glass-card mx-auto" style={{ maxWidth: "500px" }}>
              <div className="card-body p-5">
                ...
                <p className="text-light mb-4">
                  Please log in to discover and join groups with fellow movie
                  enthusiasts.
                </p>
                <button
  ...
  // Loading state
  if (isLoading) {
    return <CanvasLoader fullscreen={true} text="Loading groups..." />;
  }
  // Error state
  if (error) {
    return (
      ...
      <div className="container py-4">
        ...
        <div className="d-flex flex-column flex-sm-row align-items-start align-sm-center justify-content-between gap-3 mb-4">
          <div>
            <h1
              className={`${
                isEmbedded ? "h3" : "display-6"
              } fw-bold text-white mb-2`}
            >
              {isEmbedded ? (
                <>
