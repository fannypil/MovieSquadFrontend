...
export default function ChatWindow({
  ...
  const { messageStatuses } = useMessageStatus(
    socket,
    conversation,
    messages,
    currentUser
  ...
  if (!conversation) {
    return (
      <div
        className="chat-window d-flex align-items-center justify-content-center"
        style={{ height: "500px", backgroundColor: "#2c2c2c" }}
      >
  ...
  return (
    <div
      className="chat-window d-flex flex-column"
      style={{ height: "500px", backgroundColor: "#2c2c2c" }}
    >
      <ChatHeader
      ...
      <div
        className="messages-area flex-grow-1 overflow-auto p-3"
