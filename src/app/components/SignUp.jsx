...
export default function SignUp({onLoginSuccess}){
    ...
    <div className="d-flex justify-content-center align-items-center" style={{ minHeight: "70vh" }}>
      <div className="glass-card p-4 shadow-lg" style={{ maxWidth: 400, width: "100%", height: "100%"  }}>
        ...
        <form onSubmit={handleSignUp}>
          <div className="form-floating mb-3">
            <input
              type="text"
              className={`form-control bg-dark text-light ${errors.username ? "is-invalid" : ""}`}
              id="signupUsername"
              value={username}
            ...
            />
            <label htmlFor="signupUsername" className="text-muted">User Name</label>
