...
export default function ProfileTabs({
  ...
  const collectionsData = isViewingOtherUser
    ? userCollections
    : {
  ...
  console.log(
    "ProfileTabs rendered, activeTab:",
    activeTab,
    "isGroupView:",
    isGroupView
  );
  ...
  const tabs = isGroupView
    ...
    : [
        ...
        },
        {
          ...
          count:
            (collectionsData.favoriteMovies?.length || 0) +
            (collectionsData.watchedContent?.length || 0),
        },
      ];
              ...
              {safeGroups.length === 0 ? (
                <div className="glass-card text-center py-5 my-4">
                  ...
                  <p className="text-light mb-0">
                    {profileUser?.username || "This user"} hasn't joined any
                    groups yet.
                  </p>
                </div>
              ) : (
                <div>
                  <div className="mb-4">
                    <h5 className="text-white mb-0">
                      ...
                      {profileUser?.username || "User"}'s Groups (
                      {safeGroups.length})
                    </h5>
                        ...
                        <div className="glass-card hover-lift h-100">
                          <div className="card-body">
                            ...
                            <button
                              ...
                              onClick={() =>
                                onViewGroup && onViewGroup(group._id)
                              }
                            >
  ...
  return (
    <TabsWrapper
      ...
      variant={
        isGroupView ? "group" : isViewingOtherUser ? "user-profile" : "profile"
      }
    >
      {renderTabContent()}
    </TabsWrapper>
