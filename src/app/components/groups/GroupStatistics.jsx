        ...
        <div className="col-md-3">
          <div className="glass-card text-center">
            <div className="card-body">
              ...
              <h4 className="text-white mb-0">{group?.members?.length || stats?.memberCount || 0}</h4>
        ...
        <div className="col-md-3">
          <div className="glass-card text-center">
            <div className="card-body">
              ...
              <h4 className="text-white mb-0">{group?.sharedWatchlist?.length || 0}</h4>
          ...
          <div className="glass-card text-center">
            <div className="card-body">
              ...
              <h4 className="text-white mb-0">
                {stats?.daysActive || 
                 Math.ceil((Date.now() - new Date(group?.createdAt)) / (1000 * 60 * 60 * 24)) || 0}
              </h4>
          ...
          <div className="card-body">
            ...
            <div className="row">
              {stats.topContributors.slice(0, 6).map((contributor, index) => (
                <div key={contributor.userId} className="col-md-6 col-lg-4 mb-3">
                  <div className="d-flex align-items-center">
                    <div 
                      ...
                      style={{
                        width: '40px',
                        height: '40px',
                        backgroundColor: index === 0 ? '#ffd700' : index === 1 ? '#c0c0c0' : index === 2 ? '#cd7f32' : '#8b5cf6',
                    ...
                    <div className="flex-grow-1">
                      <div className="text-white fw-semibold">{contributor.username}</div>
                      <small className="text-light">{contributor.postCount} posts</small>
                    </div>
                    {index < 3 && (
       ...
       (!stats?.topContributors || stats.topContributors.length === 0) && (
        <div className="glass-card">
          <div className="card-body text-center py-5">
            ...
            <p className="text-light small mb-0">
              Statistics will appear here once group members start posting content.
            </p>
          </div>
        </div>
      )}
