        ...
        try {            
            ...
            if (error.response?.status === 400) {
                ...
                if (message.includes('already a member')) {
                    ...
                    errorMessage = 'As group admin, you cannot leave the group. Transfer ownership or delete the group instead.'
                } else {
                ...
                if (message.includes('private group')) {
                    errorMessage = 'This is a private group. You need an invitation to join.'
                } else {
