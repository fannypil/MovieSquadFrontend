                ...
                <div className="d-flex justify-content-between mt-1">
                  {errors.name ? (
                    ...
                    <small className="text-muted">
                      Choose a name that represents your group's focus
                    </small>
                  )}
                  <small className="text-muted">
              ...
              <div className="mb-4">
                ...
                <div className="d-flex justify-content-between mt-1">
                  {errors.description ? (
                    ...
                    <small className="text-muted">
                      Describe your group's purpose and what members can expect
                    </small>
                  )}
                  <small className="text-muted">
                      ...
                      <small className="text-light opacity-75">
                        {formData.isPrivate ? (
                          <>
                            ...
                            Private groups require approval to join. You'll
