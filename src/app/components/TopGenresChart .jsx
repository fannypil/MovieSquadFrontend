...
export default function TopGenresChart() {
    ...
    const fetchGenresData = async () => {
        try {
            ...
            console.log('Fetching genres data...'); // Debug log
            
            const headers = token ? { 'x-auth-token': token } : {};
            const response = await axios.get('http://localhost:3001/api/stats/top-genres', {
                headers
            });
            ...
            console.log('Extracted data:', apiData); // Debug log
    ...
    // Alternative: Use D3's built-in color schemes for even better variety    
    const colorScale = d3.scaleOrdinal()
        ...
        g.selectAll('.bar')
            ...
            .on('mouseover', function(event, d) {
                ...
                tooltip.html(`<strong>${d.genre}</strong><br/>${d.userCount} users`)
    ...
    return (
        <div className="w-100">
            ...
            <div className="p-3 rounded" style={{
                ...
                <svg ref={svgRef} className="w-100" style={{ minHeight: '400px' }}></svg>
            </div>
