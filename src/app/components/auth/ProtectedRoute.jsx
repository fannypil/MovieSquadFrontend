...
const ProtectedRoute = ({
  ...
  if (requiredRole && !hasRole(requiredRole)) {
    return (
      fallback || (
        <div
          className="container-fluid moviesquad-bg"
              ...
              <div className="glass-card text-center">
                <div className="card-body p-5">
                  ...
                  <p className="text-light mb-4">
                    You need <strong>{requiredRole}</strong> role to access this
                    page.
                  </p>
                  <button
  ...
  if (
    requiredPermission &&
    !checkPermission(requiredPermission, permissionContext)
  ) {
    return (
      fallback || (
        <div
            ...
            <div className="col-md-6 col-lg-4">
              <div className="glass-card text-center">
                <div className="card-body p-5">
                  <div className="mb-4">
                    <i
                      className="bi bi-lock text-danger"
                      style={{ fontSize: "4rem" }}
                    ></i>
                  </div>
