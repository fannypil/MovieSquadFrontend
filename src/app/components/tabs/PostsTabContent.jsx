...
export default function PostsTabContent({
  ...
  const canViewGroupPosts =
    !isGroupContext || !groupData?.isPrivate || isGroupMember || isGroupAdmin;
        ...
        <EmptyState
          ...
          description={
            isGroupMember
              ...
              : `No posts have been shared in ${
                  groupData?.name || "this group"
                } yet.`
          }
          showButton={false}
        />
  ...
  return (
    <div>
      <div className="mb-4">
        ...
        <p className="text-light small mb-0">{headerInfo.description}</p>
