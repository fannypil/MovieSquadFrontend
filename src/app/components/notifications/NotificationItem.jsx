...
export default function NotificationItem({
  ...
  // Match backend notification types
  ...
  return (
    <div
      className={`glass-card mb-3 ${
        !notification.read ? "border-warning" : ""
      }`}
      style={{
    ...
    >
      <div className="card-body p-3">
        <div className="d-flex align-items-start">
          {/* Notification Icon */}
          <div
            className={`flex-shrink-0 me-3 rounded-circle d-flex align-items-center justify-content-center ${getNotificationColor(
              notification.type
            )}`}
            style={{
              width: "40px",
          ...
          <div className="flex-grow-1 min-width-0">
            <div className="d-flex justify-content-between align-items-start mb-1">
              <h6 className="text-white mb-0 fw-semibold">
                {/*Use generated title or custom message */}
